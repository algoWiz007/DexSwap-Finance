...
contract ExampleSwapToPrice {
    ...
    IDexSwapRouter public immutable router;
    address public immutable factory;

    constructor(address factory_, IDexSwapRouter router_) public {
        factory = factory_;
        router = router_;
    }
    ...
    function swapToPrice(
        ...
        uint256 amountIn;
        {
            (uint256 reserveA, uint256 reserveB) = DexSwapLibrary.getReserves(factory, tokenA, tokenB);
            uint256 swapFee = DexSwapLibrary.getSwapFee(factory, tokenA, tokenB);

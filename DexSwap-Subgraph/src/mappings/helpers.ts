...
export function createLiquiditySnapshot(position: LiquidityPosition, event: ethereum.Event): void {
  ...
  snapshot.token0PriceBADGER = token0.derivedNativeCurrency.times(bundle.nativeCurrencyPrice)
  snapshot.token1PriceBADGER = token1.derivedNativeCurrency.times(bundle.nativeCurrencyPrice)
  snapshot.reserve0 = pair.reserve0
  snapshot.reserve1 = pair.reserve1
  snapshot.reserveBADGER = pair.reserveBADGER
